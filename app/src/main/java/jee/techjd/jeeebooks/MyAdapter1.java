...
public class MyAdapter1 extends RecyclerView.Adapter<MyViewHolder> {
    ...
    public MyAdapter1(Main3Activity main3Activity, ArrayList<DownModel> downModels) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        LayoutInflater layoutInflater1 = LayoutInflater.from(main3Activity.getBaseContext());
        View view1 = layoutInflater1.inflate(R.layout.elements, null, false);
